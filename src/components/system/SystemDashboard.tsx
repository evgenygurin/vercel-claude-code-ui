...
export function SystemDashboard() {
  ...
  const fetchSystemMetrics = async () => {
    ...
    try {
      ...
      // For now, we'apos;ll simulate the data
    ...
    <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Processed with jq</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">From YAML config</p>
            </CardContent>
          </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Commands used for system analysis</CardDescription>
        </CardHeader>
        <CardContent className="space-y-2">
          ...
          <div className="font-mono text-sm bg-muted p-2 rounded">
            jq 'apos;.dependencies | length'apos; package.json
          </div>
          <div className="font-mono text-sm bg-muted p-2 rounded">
            yq 'apos;.features | length'apos; config.yaml
          </div>
          <div className="font-mono text-sm bg-muted p-2 rounded">
            ast-grep --lang typescript --pattern 'apos;function...'apos;
          </div>
        </CardContent>
      </Card>
    </div>
